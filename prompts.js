...
// Obtenemos la fecha actual una sola vez para pasarla al prompt.
const hoy = new Date();
const fechaFormateada = hoy.toLocaleDateString('es-ES', { day: 'numeric', month: 'long', year: 'numeric' });

// Definimos el prompt principal para el análisis de imágenes.
const dynamicPrompt = `
<ROL_Y_OBJETIVO>
...
2.  **Identificación de Entidades:** Identifica las entidades clave: Premio, Cuentas de Instagram, Valor del premio y cualquier mención a fechas o plazos.
...
- **Premio:** Sé conciso (máx. 20 palabras). Sintetiza la información del texto y de la imagen (marcas, productos visibles). NUNCA incluyas las palabras "sorteo", "concurso" o "regalo" en la descripción.
...
- **Precio:** Si ves un valor monetario explícito en la imagen (ej: "valorado en 150€", "premio de 500€"), extráelo. Si no, déjalo como \`null\`.
